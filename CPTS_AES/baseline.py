...
from src.model.main_functions_copy import train, evaluate  # loss 그냥 계산
from src.model.models_kop import AsapBaseRegression_v2
...
class Options():
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument('--name', type=str, default='seen_aes_asap_42_kop', help='name of the experiment')
    ...
    def add_argument_options(self):
        ...
        self.parser.add_argument('--am_flag', type=bool, default=False)
